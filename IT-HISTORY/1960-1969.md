...
- [Consumer Electronics](#consumer-electronics) :
  ...
  * [Video games](#video-games) : Spacewar!, games on mainframes and minicomputers, Interactive fiction, EM games
- [Standards and protocols](#standards-and-protocols) : modem speed protocols, IMP, Telnet
- [Programming languages and frameworks](#programming-languages-and-frameworks) : APL (multidimentional array), Simula(object oriented language), BASIC (first user friendly programming language)
