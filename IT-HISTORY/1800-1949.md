...
**In short:**
- Telecommunications : Coaxial cable, analog landline phone discovery and development, electromechanical automatic telephone exchange, radiofax, first concepts and prototypes of digital switching, business telephone systems
...
- Computers :
  ...
  * Storage :  punched card reader
  * Printers : punched tape
- Uses :
  * Servers : Census, Nuclear Weapon, Monte Carlo simulations in Science
  * Clients : 
- Consumer Electronics :
  * Hardware : Phonograph - gramophone - vinyl records, microphone, electric light bulbs, vacuum tube, radios, development of batteries
  * TV / Screens : CRT discovery and development, electroluminescence discovery and first LED, liquid crystals discovery, flat-panel plasma idea, black and white TV, NTSC standard
  * Distribution media : 
  * Satellite : 
  * Video games : 
