...
- [Computers](#computers) :
  ...
  * [Uses](#uses) :
    ...
    *Clients* : Web browsers : Mozilla Firefox
...
- [Programming languages and frameworks](#programming-languages-and-frameworks): Microsoft .Net Framework, C#, Mono project (open source .NET framework implementation), Rails, Scala, F#, Unity, Roblox, Powershell, Scratch, Clojure, Nvidia CUDA, Go
