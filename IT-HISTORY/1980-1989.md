...
**In short:**
- [Inventions](#inventions) : STN passove matrix LCD screens invention, Larger (14") TFT screens
...
- [Consumer Electronics](#consumer-electronics) :
  * [Gadgets](#gadgets) : infrared LED remote control, symbolic computing and graphing calculators
  * [Multimedia](#multimedia) : Pocket LCV TVs
  * [Screens](#screens) : orange-on-black plasma screen for laptops, Flat screen CRT TV, SVGA Graphics Cards
  * [Broadcast](#broadcast) : HD-MAC - last analog HDTV system 
...
**In short:**
- Telecommunications : T3 circuits, breakup of the Bell system, birth of ILECs (1984), artificial division between long distance and local calls in the U.S. (1985) (1985), single-mode optical fibre and cable, ISDN, PON idea, ISPs
- Networking : TCP/IP emergence (IPv4), RPC, Ethernet (IEEE 802.3), multiprotocol router (Cisco IOS), original standard for Ethernet over fiber (FOIRL), first RFID related patent,  BBS, NSFNET and first internet access
- Cryptography : 
- Computers :
...
- Uses :
  * Servers : DNS, BBS, CISCOos
  * Clients : IBM DOS (Microsft MS DOS), Apple MacOS, Microsoft Windows 2.0, 
  * CGI : Pixar early history, first academy award for CGI cartoon
- Consumer Electronics:
  * Hardware : first commercially available blue LED based on the indirect bandgap semiconductor, silicon carbide (SiC), first practical OLED device
  * Gadgets : 
...
- **Pixar early history - Tin toy, 1989 Academy Award for Best Animated Short Film, first for a computer-generated film**
...
- **first fractical organic LED (OLED) device - Eastman Kodak**
