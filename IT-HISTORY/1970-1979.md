...
- Consumer Electronics :
  * Hardware : first TFT LCD and AM LCD displays, visible spectrum LED complete, earliest monochromatic flat panel LED television display, DCT Video compression idea
  * Gadgets : first single chip calculator, first TN LCD watches, electronic remote controls, first scientific calculator, first programmable calculators, speech synthesizer
  * Distribution media : 
