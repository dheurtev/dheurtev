...
- [Computers](#computers) :
  * [Form factor](#form-factor) : Timesharing capable mainframes, minicomputers (Datapoint 2200, Xerox Alto, Interdata 7/32 and 8/32), first personnal computer (Apple II), first PC with a GUI (PERQ)
  * [OS](#os) : 
