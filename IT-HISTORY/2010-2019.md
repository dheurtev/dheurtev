...
**In short**
- Telecommunications : Phasing out ISDN
- Networking : Energy efficient ethernet / Green Ethernet, 40 GbE /100 GbE (core), 2.5 GbE/5 GbE (home/business), NFC deployment, Terabyte ethernet research (200 GbE, 400 GbE standards)
- Cryptography : 
- Computers :
  * Hardware : Tablet computers, Cloud computing, end of mainframes 
  * CPU : CPUs with northbridge capabilities
  * Motherboard : NVMe, M.2, Northbridge disappears
  * Storage : SSD/RAM convergence, M.2 SSD, NVMe SSD emergence
  * Printers:  Transition to laser printers
- Uses :
  * Servers : Nginx growth
  * GUI : Microsoft Windows 8, Google ChromeOS
  * Web browsers : Google Chrome, Google Chromium based browser
- Consumer Electronics :
  * Hardware : Apple Watch, Apple iPhone X, inkjet printed OLED, universal remotes via infrared emitters in smartphones, bulk manufacturing of quantum dots, MicroLED demonstration
  * TV / Screens : Touchscreen, high DPI display, UHD (4K), TV/PC/phone screen resolution convergence, QLED TV, high contrast LCD displays, plasma decline and demise, shift to OLED in premium TV markets
  * Distribution media : streaming services growth, Ultra HD Blu-Ray, decline of CD/DVDs 
  * Satellite : 
  * Video games : Microsoft Xbox One, Sony PlayStation 4
- Standards and protocols : Broadband via electric power lines (IEEE Std 1901-2010), energy efficient ethernet, 40 GbE -> 400 GbE, HTTP/2, new wave of file compression (Snappy, Zstd),
- Programming languages and frameworks : Microsoft .NET framework, Vulkan, Microsoft .NET core
