...
- Computers :
  ...
  * Screens : interactive user terminals
- Uses :
  ...
  * Clients : Airline booking, ATM Cash machine, first layout software
- Consumer Electronics :
  * Hardware : Shift to PCB in consumer electronics, programmable calculators, 
  * Distribution mediau : magnetic stripe invention
  * TV : PAL/SECAM, CRT innovation (Sony Trinitron - 1968), first practical plasma video display (1964)
