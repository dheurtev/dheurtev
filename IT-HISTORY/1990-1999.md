...
- Consumer Electronics :
  * Hardware : High brightness blue led, First white LED sold, high-efficiency green light-emitting polymer-based device, idea of using quantum dots as light source
