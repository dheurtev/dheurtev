...
- Computers :
  ...
  * Screens : rudimentary interactive interface (the console) 
...
- Uses :
  ...
  * Clients : first compiler and first programming languages, computer music, video games, hacker culture
- Consumer Electronics :
  * TV : Shift from circular CRT to rectangular CRT, first color CRT, U.S. color TV standard (NTSC)
