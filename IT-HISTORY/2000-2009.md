...
**In short:**
- Telecommunications :  IP convergence, Fiber optic to home, Multi-mode fiber, Passive fiber optic network, 
- Networking : Internet everywhere, Power over Ethernet, RFID tags + payments + transportation, Industrial Ethernet, MPLS deployment
- Cryptography : 
- Computers:
  * Hardware : Legacy free PCs, Transition to SSD starts
  * CPU: 
  * Motherboard : 
  * Screens : computer/TV screen convergence, 16:9 TV, Widescreen (1366x768), Full HD (1080p = 1920x1080) 
