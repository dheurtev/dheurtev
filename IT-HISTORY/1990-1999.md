...
- Networking : Transition to IP traffic, Frame Relay, ATM, birth of IPv6, ethernet to Gigabit Ethernet, early-form RFID, development of MPLS
- Web/internet (HTTP servers and browsers, HTML, URL, XML)
- Home computer: Microsoft Windows 3.0, 3.1, 95, 98 
- Laptop
- Screens : XVGA
...
- Mobile: PDA (PCMIA), Bluetooth development
- TV : HDTV
- Distribution media : DVD
- Web server : Apache
- Web browser : Netscape Navigator, Internet Explorer
- Video games : fourth (Super NES) to fifth generation video game consoles (Nintento 64, Playstation)
- Standards : JPEG, MPEG-1, MPEG-2, WAV, MP3, PNG, SIP, SSH, VNC, Rsync, CORBA, ZIP compression tools and competitors (Winzip, RAR, ARJ, DEFLATE, 7-zip), CIFS, SOCKS, PPTP
