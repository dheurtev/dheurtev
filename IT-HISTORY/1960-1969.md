...
**In short:**
- [Inventions](#inventions) : Automated Deposit Machine, first visible-spectrum (red) LED demonstration, TFT - ELD display invention, computer mouse, CMOS, "Protocol", Magnetic stripe card, Intel founded, AMD founded
...
- [Cryptography](#cryptography) : Government control
- [Computers](#computers) :
  ...
  * [OS](#os) : IBM hardware (0S/360, DOS/360) and other mainframe operating systems : Control Data Corporation (SCOPE), UNIVAC 1107, Burroughs Corporation (B5000), GE (GE-600), Digital Equipment Corporation (TOPS-10), Scientific Data Systems/Xerox Data Systems
...
- [Consumer Electronics](#consumer-electronics) :
  * [Multimedia](#multimedia) : printing programmable calculator, handheld calculator, first direct-drive turntable
