...
- Consumer Electronics :
  * Hardware : first TFT LCD and AM LCD displays, visible spectrum LED complete, earliest monochromatic flat panel LED television display, DCT Video compression idea, Phonograph improvement : Shibata stylus, 
  * Gadgets : first single chip calculator, first TN LCD watches, Technics SL 1200, electronic remote controls, first scientific calculator, first programmable calculators, speech synthesizer
  * Distribution media : 
  * TV / Screens : Panaplex display (gas-plasma display), Ceefax Teletext, TV as computer screens
...
- **first TFT LCD and AM LCD displays (1973-1974)**
