...
**In short**
- Cloud computing, end of mainframes
...
- Hardware : Tablet computers, Touchscreen, SSD/RAM convergence 
- Motherboard : NVMe, M.2, Northbridge disappears
- Screens: UHD (4K), TV/PC/phone screen convergence
- Printers : Transition to laser printers
- Distribution media : Decline of CD/DVDs, streaming services growth
- Video games : Microsoft Xbox One, Sony PlayStation 4
- Web server : Nginx
- Gui : Microsoft Windows 8, Google ChromeOS
- Browser : Google Chrome, Google Chromium based browser
