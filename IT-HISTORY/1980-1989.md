...
- [Programming languages and frameworks](#programming-languages-and-frameworks) : object-oriented, dynamically typed reflective programming language (Smalltalk), Meta, C++, Erlang, Perl
