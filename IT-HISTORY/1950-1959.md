...
- Cryptography : 
- Computers :
  * Hardware : first workable silicon transistor, first generation mainframe, early trackball, first UART and connectors, first integrated circuit
  * CPU : Transistor era, first integrated circuit
  * Motherboard : PCB development, planar process
...
- Consumer Electronics :
  * Gadgets : TV remote controls, first transistor radio
...
- **Planar process (1959) - Fairchild Semiconductor**
