...
**In short:**
- IP convergence
- Networking : Fiber optic to home, Internet everywhere, Multi-mode fiber, Passive optic network, Power over Ethernet, 10 GB ethernet, RFID tags + payments + transportation, Industrial Ethernet, MPLS deployment
- Hardware : Legacy free PCs, Widescreen, Transition to SSD starts
- Motherboards : USB/SATA/SAS/PCI-E iterations, Southbridge disappears, UEFI
...
- Distribution media : Blu-Ray
- Web server : NginX
- Gui : Windows XP, Vista, 7
- Browser : Mozilla Firefox
- TV : HDTV in Europe 
- Video games : Sixth generation video games consoles (PlayStation 2, Xbox, Nintendo Wii)
- Real-time protocols and automation protocols
- Standards : DivX, MPEG-4, RDP, JSON, SVG, ISO, SMB 2.0, HTML5  
...
Focus on passive fiber optic network (G.983, G.984) deployments.
