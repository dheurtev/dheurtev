...
- Uses:
  * Servers : DNS
  * GUI : IBM DOS (Microsft MS DOS), Apple MacOS, Microsoft Windows 2.0
- Consumer Electronics:
  * Distribution media : CD
  * Satellite : TVRO/C-band era
  * Video games : Golden age - third generation of video games consoles (NES, Sega Master), crash of 1983 (ET Game), fourth generation of video games consoles generations (NEC Home Electronics, Gameboy)
