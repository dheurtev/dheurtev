...
- Consumer Electronics :
  * Hardware : first TFT LCD and AM LCD displays, visible spectrum LED complete, earliest monochromatic flat panel LED television display
  * Gadgets : first TN LCD watches
  * Distribution media : 
  * TV / Screens : Panaplex display (gas-plasma display), DCT Video compression idea, TV as computer screens
