...
- Computers :
  * Hardware : Mainframes, Typewriter and Teletype devices, communication port, standard TTL, LED invention, MOS for logic and switching applications, op amp
  * CPUs: first commercial MOS integrated circuit (1964),
  * Motherboard : CMOS
...
- Consumer Electronics :
  * Hardware : Shift to PCB in consumer electronics, programmable calculators, first commercial infrared LED, first visible spectrum LED discovery, first LED display, first alphanumeric LED display
  * Gadgets : printing programmable calculator, handheld calculator, first direct-drive turntable
