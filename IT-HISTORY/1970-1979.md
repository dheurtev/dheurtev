...
- [Programming languages and frameworks](#programming-languages-and-frameworks) : Pascal (minicomputers, teaching language), Prolog (Natural language processing, rule-based logical queries), **ADA (ISO standard, military applications, critical real time applications), C (The Unix language, OS programming, embedded system applications)**, MATLAB (engineering matrix manipulation, plotting and UI)
