...
**In short:**
- Telecommunications : SPC telephone exchange deployment (Number One Electronic Switching System), T-carrier, first satelitte, fax machine, PCM exchange, Centrex
- Networking : "Protocol" invention, Bell 103A modem, ARPANET
- Cryptography : Government controlled
- Computers :
  * Hardware : Mainframes, Typewriter and Teletype devices, CMOS/MOS era, communication port
...
- **Centrex - PBX alternative (1960s-2000s)**
