...
- [Electronics](#electronics) : From published schematic diagrams to motherboards, Intel i286, Intel i386, IA-32 architecture (i386), UART serial communication, first commercial flash memory, first commercial blue LED based on the indirect bandgap semiconductor, Intel i486
- [Energy](#energy) : 
...
- [Computers](#computers) :
  ...
  * [Peripherals](#peripherals) : Laser printing to mass markets, AT/ISA bus, Apple Desktop Bux, PS/2, EISA bus
