...
- home computer
- Motherboard : VESA, PCI, USB 
- laptop and PDA (PCMIA)
- Screens : XVGA
- HDTV
- DVD
- fourth (Super NES) to fifth generation video game consoles (Nintento 64, Playstation)
- Standards : JPEG, MPEG-1, MPEG-2, WAV, MP3, PNG, SIP, SSH, VNC, Rsync, ZIP compression tools and competitors (Winzip, RAR, ARJ, 7-zip)
