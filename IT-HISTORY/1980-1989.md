...
**In short:**
- Telecommunications : T3 circuits, single-mode optical fibre and cable, ISDN, PON idea
- Networking : TCP/IP emergence (IPv4), Ethernet (IEEE 802.3), original standard for Ethernet over fiber (FOIRL), First RFID related patent, RPC
- Age of RSA cryptography 
- PC industry
- CD era
- GUI/Mouse
- CPU: x86 era and IA-32(i386) architecture
- Motherboard : from published schematic diagrams to single Integrated Circuits with PS/2, ISA, SCI, PATA/ATA/IDE, UART
- Screens : SVGA
- Color inkjet printers and laser printers
- DNS
- TVRO/C-band satellite era
- Golden age of video games : third generation of video games consoles (NES, Sega Master), crash of 1983 (ET Game), fourth generation of video games consoles generations (NEC Home Electronics, Gameboy)
- Standards : Compact Disc Digital Audio, WWW, BMP, GIF, email protocols, IRC, Zip (PKZIP), ISO 9660 file system, EDI (EFIFACT, ODETTE/OFTP), Netbios, SMB
