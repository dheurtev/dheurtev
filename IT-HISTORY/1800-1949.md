...
**In short:**
- [Inventions](#inventions) : early fax, liquid crystals discovery, electroluminescence discovery and first LED, first concepts and prototypes of digital switching, flat-panel plasma idea, satelitte idea, Williams tube (RAM), first static (non-moving) magnetic memory, trackball, transistor invention
...
- [Computers](#computers) :
  * [Form factor](#form-factor) : Colossus, ENIAC
