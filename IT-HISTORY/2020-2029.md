...
- [Networking](#networking) : Terabit ethernet, quantum key distribution
- [Cryptography](#cryptography) : 
- [Computers](#computers) :
  * [Form factor](#form-factor) : 
  * [OS](#os) : 
  * [Peripherals](#peripherals) : End of optic drives
  * [Storage](#storage) :  
  * [Uses](#uses) :
- [Consumer Electronics](#consumer-electronics) :
  * [Gadgets](#gadgets) :
  * [Multimedia](#multimedia) : 
  * [Screens](#screens) : from OLED to QD-LED, shipment of LCD TV falls
  * [Broadcast](#broadcast) :
  * [Video games](#video-games) : Microsoft Xbox series, Sony PlayStation 5
- [Standards and protocols](#standards-and-protocols) : Terabit ethernet, HTTP/3, quantum key distribution
- [Programming languages and frameworks](#programming-languages-and-frameworks): Microsoft .NET
